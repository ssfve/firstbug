...
#bg_color = '#F4F4F4';
imageID = str(gameid)+'_'+pageType+'_'+location
image_name = pageType+'_'+location+'.jpg'
...
def bgg_xml_reader():
    ...
    for gameid in game_list:
        ...
        column_str = '(imageID,gameid,pageType,location,image_path)'
        value_str = str((imageID,gameid,pageType,location,image_path))

...
merged_category_dict = create_merged_categorylist()
...
def bgg_xml_translater(games_dict):
    ...
    for gameid in games_dict:
        ...
        for category in categorys:
            ...
            cat_set.add(merged_category_dict[category])
        cat_set_str = '|'.join(cat for cat in cat_set)
        print cat_set_str
        """
        for designer in designers:
        ...
        if cat_set_str == '':
            ...
            column_str += 'catMerged,'
            value_str += '"'+str(cat_set_str)+'",'
...
if __name__ == '__main__':
    bgg_xml_translater(nameCN_dict)